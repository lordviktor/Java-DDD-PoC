...
public class MedicamentoControllerTest {
    ...
    @Test
    @DatabaseSetup(type = DatabaseOperation.CLEAN_INSERT, value = "/datasets/myDataset.xml")
    public void tryToRetrieveAllMedicaments() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/farmacia/1/medicamento")).andExpect(status().isOk());
    }
}
